import { type FormTaskFields } from "@/types";
import getTaskFormData from "@/utils/getTaskFormData";
import Modal from "react-modal";

type Props = {
  isOpen: boolean;
  onClose: () => void;
  onSave: (taskData: FormTaskFields) => void;
};

const TaskModal: React.FC<Props> = ({ isOpen, onClose, onSave }) => {
