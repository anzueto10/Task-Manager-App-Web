        ...
        <MainSectionContainer background="muted">
          <article className="flex flex-col items-center justify-center space-y-2 text-center">
            ...
            <p className="max-w-[900px] text-mutedForeground-light dark:text-mutedForeground-dark md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              Tasker provides a comprehensive set of tools to help you stay on
              top of your projects and tasks. From project management to task
              tracking and collaboration, Tasker has you covered.
            </p>
          </article>
        ...
        <MainSectionContainer grid gridCols={2}>
          <article className="space-y-2">
            ...
            <p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              Tasker is designed to help you and your team work more
              efficiently. With its intuitive interface and powerful features,
              you'll be able to focus on what matters most.
            </p>
          </article>
